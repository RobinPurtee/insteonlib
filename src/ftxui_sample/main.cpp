...
// configuration step. It creates a namespace called `insteonlib`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", insteonlib::cmake::project_name, insteonlib::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", insteonlib::cmake::project_version);
      return EXIT_SUCCESS;
    }
